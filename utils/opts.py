...
def train_options():
    ...
    parser.add_argument('--config', default="model_configs/lm_prior.yaml")
    parser.add_argument('--name', default="lm_3w")
...
def seq2seq2seq_options():
    parser = argparse.ArgumentParser()
    parser.add_argument('--config', default="model_configs/ds.full.yaml")
    parser.add_argument('--name', default="test-justice-out")
    parser.add_argument('--desc')
    parser.add_argument('--resume')
    parser.add_argument('--visdom', action='store_true')
    ...
    parser.add_argument('--source', nargs='*', default=["models", "modules", "utils"])
